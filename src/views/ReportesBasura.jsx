...
const ReportesBasura = () => {
  ...
  const cargarReportes = async () => {
    try {
      ...
      console.log("Reportes de basura cargados:", reportesData.length);
  ...
  const generarPDF = async () => {
    ...
    try {
      ...
      // Título
      pdf.text(`Reporte de Basura Acumulada - Folio: ${reporteSeleccionado.folio || 'N/A'}`, 15, 20);
      ...
      // Guardar el PDF
      pdf.save(`Reporte_Basura_${reporteSeleccionado.folio || reporteSeleccionado.id}.pdf`);
        ...
        <div className="reporte-modal">
          <div className="reporte-modal-content">
            <div className="reporte-modal-header">
              <h2>
                Basura Acumulada - Folio: {reporteSeleccionado.folio}
              </h2>
