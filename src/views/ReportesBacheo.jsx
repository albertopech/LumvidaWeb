...
const ReportesBacheo = () => {
  ...
  const generarPDF = async () => {
    ...
    try {
      ...
      // Título
      pdf.text(`Reporte de Bacheo - Folio: ${reporteSeleccionado.folio || 'N/A'}`, 15, 20);
      ...
      // Guardar el PDF
      pdf.save(`Reporte_Bacheo_${reporteSeleccionado.folio || reporteSeleccionado.id}.pdf`);
        ...
        <div className="reporte-modal">
          <div className="reporte-modal-content">
            <div className="reporte-modal-header">
              <h2>
                Bacheo - Folio: {reporteSeleccionado.folio}
              </h2>
